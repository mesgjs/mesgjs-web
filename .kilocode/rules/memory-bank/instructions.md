...
### Core Files (Required)
1. `brief.md`
   - Definitely read this file, but do not modify this file unless explicitly instructed to do so by the user.
   - This file is typically created and maintained manually **by the user**.
   - It is, however, appropriate to suggest updates it if it can be improved.
